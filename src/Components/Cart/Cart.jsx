...
export default function Cart() {
  let { cart, getCart, updateProduct, deleteProduct, clearCart, loading } =
    ...
    <>
      ...
      {!cart ? (
        <div className="flex justify-center items-center w-full h-[400px]">
          <h1 className="text-main text-5xl md:text-6xl">
            There is no Products
          </h1>
        </div>
      ) : (
        <>
              ...
              <table className="w-full text-sm text-left text-gray-500">
                ...
                <tfoot>
                  <tr className="font-semibold text-gray-900">
                    <td className="ps-16 py-3 text-xl" colSpan={3}>
                      Total
                    </td>
                    <td className="px-6 py-3 text-xl" colSpan={2}>
          ...
          <div className="flex justify-center my-3">
            <Link to={"/checkout"} className="bg-main w-full md:w-[50%] text-center py-2 mx-2 rounded text-white">
              Checkout
            </Link>
          </div>
        </>
